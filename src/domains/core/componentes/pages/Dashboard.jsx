          ...
          <div className="w-full lg:w-[42rem] xl:w-[55rem] m-auto px-8 pb-8 xl:px-24">
            <div>
              <p className="text-lg font-semibold">
                Hello, {isAuthenticated && user ? user.userName : ""} welcome
                back!
              </p>
              <em className="text-3xl font-semibold not-italic">
                Your dashboard
              </em>
            </div>
            ...
            <InfoTabs
              ...
              icon={
                user && (!user.isTeacher || !isTeacherRoute) ? "search" : "add"
              }
              path={
                user && (!user.isTeacher || !isTeacherRoute)
                  ? "/student/courses"
            ...
            <InfoTabs
              ...
              icon={
                user && (!user.isTeacher || !isTeacherRoute) ? "add" : "search"
              }
              path={
                user && (!user.isTeacher || !isTeacherRoute)
                  ? "/student/my-requests"
