...
export const ButtonProfileAddCard = ({ onClick = () => {}, children }) => {
  return (
    <button
      onClick={onClick}
      className="flex flex-row gap-2 justify-center items-center px-4 py-1.5 bg-blue-500 hover:bg-blue-600 rounded-lg cursor-pointer  text-white fill-white"
    >
      <svg
        className="h-4"
        viewBox="0 0 19 19"
